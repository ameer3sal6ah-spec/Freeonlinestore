  ...
  return (
    <div className="container mx-auto px-6 py-20 text-center">
      <div className="bg-white p-10 rounded-lg shadow-lg max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">تم استلام طلبك بنجاح!</h1>
        <p className="text-gray-600 mb-6">شكراً لثقتك بنا. سنتواصل معك قريباً لتأكيد تفاصيل الشحن.</p>
        {orderId && (
          <div className="bg-gray-100 p-4 rounded-md inline-block">
            <span className="text-gray-500">رقم طلبك هو:</span>
            <strong className="text-gray-800 text-lg mx-2">{orderId}</strong>
          </div>
        )}
        <div className="mt-8">
